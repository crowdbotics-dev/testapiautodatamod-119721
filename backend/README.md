...
## Project Structure
    ...
    ├── testapiautodatamod_119721  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_119721`
...
2. Clone this repo and `cd testapiautodatamod_119721`
